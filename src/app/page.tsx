  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      <AppSidebar 
        ...
        onSelectVideo={(id) => setVideoId(id)}
          ...
          <div className="max-w-[1920px] mx-auto"> {/* This ensures content within doesn't exceed max width */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-6"> {/* Reduced gap */}
              ...
              <div className="lg:col-span-5 xl:col-span-4 order-2">
                <Card className="rounded-lg sm:rounded-xl overflow-hidden bg-white shadow-sm border border-slate-100 h-[calc(100vh-11rem)] sm:h-[calc(100vh-12rem)] flex flex-col">
                  <ChatTabs
                    jobId={jobId}
                    videoId={videoId}
                    currentUser={currentUser}
